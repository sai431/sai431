...
public class EmployeeInfoController {
	...
	public EmployeeRespDto createEmployeeInfo(@Valid @RequestBody Employee employeeEntity) {
		EmployeeRespDto empresp = null; // if
		/*
		 ...
		 */
		/*
		 * for (FieldError fieldError : errors) { ErrorDetails errorDet=new
		 * ErrorDetails(); errorDet.setDefaultMessage(fieldError.getDefaultMessage());
		 ...
		 * fieldError.getDefaultMessage(), fieldError.getObjectName()); } }
		 */// else {
		...
		//}
		/*
		 * else { EmployeeNotFoundException exception = new EmployeeNotFoundException(
		 * "The emp id " + employeeEntity.getEmpId(), "Please Provide valid Input");
		 * empresp = new EmployeeRespDto(exception); }
		 */
		return empresp;
